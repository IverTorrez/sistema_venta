             ...
             <tbody>
              ...
              ?>
               <tr>
                 ...
                 <td><?php echo $fila->idcompraprod; ?></td>
...
<script type="text/javascript">
  function calculosubtotal(cantidad,idprod,precVenta,stockTotal)
  {
   ...
   var subtotalprod=cantidad*precVenta;
     if (parseInt(cantidad)<=parseInt(stockTotal)) /*preguntamos si la cantidad que vendera no supera el stock*/
     {
          ...
          if (Cheq1==false) /*preguntamos si esta chequeado venta facturada, por verdadero, osea no es venta facturada*/
          {
            ...
            switchfactura="no";
                      ...
                      return swal({
                                 ...
                                 text: "El precio sugerido por unidad para el producto: "+nombreP+" es "+precioP+" Bs.",
                                 type: "warning",
                                 confirmButtonText: "¡Cerrar!"
                            });
              ...
              switchfactura="si";
                     ...
                     var respuestas= await $.ajax({
                      ...
                      return swal({
                                 ...
                                 text: "El precio sugerido por unidad para el producto: "+nombreP+" es "+precioPFact+" Bs.",
                                 type: "warning",
                                 confirmButtonText: "¡Cerrar!"
                            });
                      }/*fin del if quepregunta si idprodcompra es mayor a cero */
